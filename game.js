...
window.onload = function () {
    ...
    imgCake.src = "img/drop2.png";
    imgMan.src = "img/man.png";
    imgWoman.src = "img/woman.png";
...
function CreateFallObj(){
    let obj = {
        ...
        count: 0,
        second: 0,
        type: Math.floor(Math.random()*Math.random() * 2),
        flag: true,
    };
    fallObj.push(obj);
}
...
function GameDraw() {
    ...
    //背景の表示
    //分割して表示
    let n = Math.floor(SecondCount() / 500);
    let x1 = 570 - 570 * Math.pow(-1, n);
    let y1 = 2026 * Math.floor(n / 2);
    v.drawImage(imgBack, x1 ,y1 ,1140, 2026, 0, 0, WIDTH, HEIGHT);
    ...
    for (let i = 0; i < fallObj.length; i++) {
        ...
        if (object.flag) {
            ...
            switch (object.type) {
                case 0:
                    ...
                    break;
                case 1:
                    v.drawImage(imgCake, object.x, object.y, 50, 50);
                    break;
                default:
                    v.drawImage(imgCho, object.x, object.y, 50, 50);
                    break;
        ...
        if (0 < object.count && object.count < 25) {
            object.count++;
            v.fillText("+" + 100 * (1 + object.type), object.x, object.y - object.count);
        }
    }
